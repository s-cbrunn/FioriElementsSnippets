...
sap.ui.define([
	 ...
	 */
	Requestor.prototype.batchRequestSent = function (sGroupId, aRequests, bHasChanges) {
		var oPromise,
			fnResolve;
	 ...
	 * @see #waitForRunningChangeRequests
	 */
	Requestor.prototype.batchResponseReceived = function (sGroupId, aRequests, bHasChanges) {
		var aPromises;
